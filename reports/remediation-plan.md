...
| P1 | AF-004 | Excessive data exposure may leak customer and internal data in one response | API owner | Confirm `/api/orders/1001` excludes internal fields and only returns required order data |
